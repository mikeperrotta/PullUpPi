...
class ScoreKeeper:
    ...
    def draw_statics(self):
        ...
        daily_goal_text_surface = self.title_font.render(daily_goal_text, True, (52, 52, 52))
        ...
        lifetime_score_text_surface = self.title_font.render(lifetime_score_text, True, (52, 52, 52))
        self.window_surface.blit(lifetime_score_text_surface, (self.resolution[0] * 3 // 4 - lifetime_score_text_surface.get_size()[0] // 2, 150))
        daily_goal_surface = self.number_font.render(str(self.goal), True, (52, 52, 52))
    ...
    def update_scores(self, daily_completed, lifetime_score):
        self.draw_statics()
        daily_completed_surface = self.number_font.render(str(daily_completed), True, (52, 52, 52))
